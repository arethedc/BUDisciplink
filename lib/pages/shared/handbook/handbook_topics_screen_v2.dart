...
class HandbookTopicsScreenV2 extends StatefulWidget {
  ...
  @override
  State<HandbookTopicsScreenV2> createState() => _HandbookTopicsScreenState();
}

class _HandbookTopicsScreenState extends State<HandbookTopicsScreenV2> {
