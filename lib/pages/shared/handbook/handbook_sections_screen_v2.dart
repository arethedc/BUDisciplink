...
import 'handbook_topic_content_screen_v2.dart';
import 'handbook_topics_screen_v2.dart';
import 'handbook_ai_assistant_sheet.dart';

class HandbookSectionsScreenV2 extends StatefulWidget {
  final bool useSidebarDesktop;

  const HandbookSectionsScreenV2({super.key, this.useSidebarDesktop = true});

  @override
  State<HandbookSectionsScreenV2> createState() =>
      _HandbookSectionsScreenState();
}

class _HandbookSectionsScreenState extends State<HandbookSectionsScreenV2> {
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.useSidebarDesktop && !isDesktop && _selectedTopic != null) {
      return HandbookTopicContentScreenV2(
