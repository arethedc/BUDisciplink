...
class HandbookTopicContentScreenV2 extends StatefulWidget {
  ...
  const HandbookTopicContentScreenV2({
    super.key,
    required this.topic,
  ...
  @override
  State<HandbookTopicContentScreenV2> createState() =>
      _HandbookTopicContentScreenState();
}

class _HandbookTopicContentScreenState
    extends State<HandbookTopicContentScreenV2> {
